...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_15|GPIO_PIN_9, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12|GPIO_PIN_14|GPIO_PIN_10, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PB12 PB14 PB15 PB9 */
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_14|GPIO_PIN_15|GPIO_PIN_9|GPIO_PIN_0|GPIO_PIN_10|GPIO_PIN_11;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = SIDE_KEY_INPUT_Pin ;   //|GPIO_PIN_8;
  ...
  /*Configure GPIO pin : PA12 FP_WAKE_UP  */
...
void LowPower_GPIO_Set(void)
{
  ...
  /*Configure GPIO pins : PA5 PA6 PA7 PA11 */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_8|GPIO_PIN_15;
 ...
 // GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PA5 PA6 PA7 PA11 */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_6|GPIO_PIN_5\
  						|GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG ;
 // GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
//
//   /*Configure GPIO pins : PAPin PAPin */
//  GPIO_InitStruct.Pin = SIDE_KEY_INPUT_Pin;
//  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING ; //WT.EDIT 2022.08.20
//  GPIO_InitStruct.Pull = GPIO_NOPULL;
//  HAL_GPIO_Init(SIDE_KEY_INPUT_GPIO_Port, &GPIO_InitStruct);
